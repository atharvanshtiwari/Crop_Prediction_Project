    ...
    with res_col2:
        ...
        with st.spinner("Analyzing farm data and generating expert advice..."):
            try:
                ...
                Write a highly encouraging, professional 3-4 line note to the farmer explaining what to expect with this crop and giving one quick, specific farming tip based on their exact metrics. Do not use markdown formatting. After writing those 3-4 line of note, leave 1-2 lines of space and then translate the same english(first in english and then in hindi) sentence in Hindi
                """
